"use strict";(self.webpackChunkbphc_ulti_strapi=self.webpackChunkbphc_ulti_strapi||[]).push([[4121],{11199:(U,p,t)=>{t.r(p),t.d(p,{default:()=>ue});var e=t(67294),o=t(81849),b=t(87751),m=t(16550),L=t(86896),O=t(14087),C=t(17034),D=t(185),c=t(53979),f=t(36989),i=t(75515),M=t(29728),x=t(49066),H=t(41580),_=t(38939),ee=t(49386),te=t(8060),G=t(79031),E=t(37909),N=t(41451),ne=t(63237),le=t(15234),S=t(11047),y=t(45697),V=t(71997);const $=V.ZP.div`
...
`,C=(0,b.ZP)(O)`
  flex-shrink: 0;
`,D=({startActions:c,endActions:f})=>c||f?e.createElement(m.x,{paddingLeft:10,paddingRight:10},e.createElement(m.x,{paddingBottom:4},e.createElement(L.k,{justifyContent:"space-between",alignItems:"flex-start"},c&&e.createElement(O,{wrap:"wrap"},c),f&&e.createElement(C,{pullRight:!0},f)))):null;D.defaultProps={endActions:void 0,startActions:void 0},D.propTypes={endActions:o.node,startActions:o.node}},49386:(U,p,t)=>{t.d(p,{c:()=>f});var e=t(67294),o=t(45697),b=t(71997),m=t(41580),L=t(70004),O=t(11047),C=t(75515);const D=(0,b.ZP)(m.x)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
...
`,c=(0,b.ZP)(m.x)`
  ...
  width: 100%;
  border: none;
`,f=({children:i,icon:M,...x})=>e.createElement("div",null,e.createElement(L.i,null),e.createElement(c,{as:"button",background:"primary100",padding:5,...x},e.createElement(O.k,null,e.createElement(D,{"aria-hidden":!0,background:"primary200"},M),e.createElement(m.x,{paddingLeft:3},e.createElement(C.Z,{variant:"pi",fontWeight:"bold",textColor:"primary600"},i)))));f.propTypes={children:o.string.isRequired,icon:o.node.isRequired}}}]);
